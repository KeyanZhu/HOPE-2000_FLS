...
INT16U	uwGridpowerslopeTime = 50;//100;//140;//240;//60;	// 电网功率软起斜率
...
//	}
	...
	wWattTemp = wOPLOadMaxTemp;//swGetROpWattNew();
...
//	INT16S wOPVATemp = 0;
//	INT16S wOPVarTemp = 0;
	wOPWatTemp = swGetROpWattNew();
	wOPVATemp = swGetROpVANew();
	wOPVarTemp = swGetROpVarNew();
									//  三个取最大值
