...
INVLOADOP_JOB INT16S	swGetWattDeratePerTemp(void); 
INVLOADOP_JOB INT16S	swGetWattDeratROpVolt(void);
INVLOADOP_JOB INT16S 	sOPOverLoadLowvolt(INT16S wOpVoltTemp);
INVLOADOP_JOB INT16S 	swGetOPLoadLevelCnt(void);
INVLOADOP_JOB INT16S	swGetEnergySpareVoltLimit(void); 
INVLOADOP_JOB INT16S	swGetToShutdown(void); 
...
INVLOADOP_JOB void		sSetEnergySpareVoltLimit(INT16U uwTemp);
INVLOADOP_JOB void		sSetToShutdown(INT16U uwTemp);
