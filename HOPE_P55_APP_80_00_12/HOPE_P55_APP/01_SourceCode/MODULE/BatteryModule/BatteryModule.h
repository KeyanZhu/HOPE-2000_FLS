...
BATTERY_MODULE void		sBatOVAlarmChk(INT16U uwBatOpenLevel, INT16U uwFilter);
...
BATTERY_MODULE void		sPv1UnderChk(INT16U uwFilter,INT16U uwFilter1);
...
BATTERY_MODULE void		sBatCurrOverChk(INT16U uwBatCurrOverLevel, INT16U uwFilter,INT16U uwBatCurrOverLeve2, INT16U uwFilter2 );
BATTERY_MODULE void		sTrickleChg(void);
...
BATTERY_MODULE INT16S	swGetMinCellVoltNew(void);
BATTERY_MODULE INT16S	swGetMaxCellVoltNew(void);
BATTERY_MODULE INT16S	swGetAvgCellVoltNew(void);
...
BATTERY_MODULE INT16S	swGetMinCellVoltFilter(void);
BATTERY_MODULE INT16S	swGetMaxCellVoltFilter(void);
BATTERY_MODULE INT16S	swGetAvgCellVoltFilter(void);
...
BATTERY_MODULE INT16S	swGetTriChgFlag(void);
...
BATTERY_MODULE void	sSetMinCellVoltNew(void);
