...
#define cBusHWVoltOver			30	// 母线硬件过压故障
...
union T_ALARM_BASE
{
	...
	// 告警信息4 sys & BMS	
		...
		INT16U 	bAlarm4Rsvd2:1;				// 预留
		INT16U 	bPv1HWOCAlarm:1;			// PV1硬件过流告警 					支持	
		INT16U	bPvBTNTCLoss:1;				// PV boost NTC未接 				支持	
