...
#define CMPSS2_LLC_BASE 		CMPSS2_BASE
...
#define ADCARESULT8			AdcaResultRegs.ADCRESULT8	// LV_12V.V	A12		第二版： LLC.OCP		A12
#define ADCARESULT9			AdcaResultRegs.ADCRESULT9	// OP.V		A14
#define ADCARESULT10		AdcaResultRegs.ADCRESULT10	// LLC.OCP	A15		第二版： LV_12V.V		A15
...
#define mAUXENOn 			GpioDataRegs.GPCCLEAR.bit.GPIO66 = 1     //反了？？？？？？？
#define mAUXENOff 			GpioDataRegs.GPCSET.bit.GPIO66 = 1

// PV_FAN.EN	 PV防反信号
#define mPV_FANEN     		GpioDataRegs.GPBDAT.bit.GPIO42
#define mPV_FANENOff 		GpioDataRegs.GPBCLEAR.bit.GPIO42 = 1    
#define mPV_FANENOn 		GpioDataRegs.GPBSET.bit.GPIO42 = 1
...
********************************************************************************/
INITIAL INT16S	swGetuwPWM1_TZ_Cnt(void);
