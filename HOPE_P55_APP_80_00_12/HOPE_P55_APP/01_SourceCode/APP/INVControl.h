...
#define			mRPInvPWM				EPwm2Regs.CMPA.bit.CMPA
#define			mRNInvPWM				EPwm1Regs.CMPA.bit.CMPA
#define			mLPInvPWM				EPwm2Regs.CMPB.bit.CMPB
#define			mLNInvPWM				EPwm1Regs.CMPB.bit.CMPB
...
#define 		mEnForceLUHigh()		EPwm2Regs.AQCSFRC.bit.CSFA = 1;\
										EPwm2Regs.AQCSFRC.bit.CSFB = 2;
#define 		mEnForceLULow()			EPwm2Regs.AQCSFRC.bit.CSFA = 2;\
										EPwm2Regs.AQCSFRC.bit.CSFB = 1;
#define 		mDisForceLUPWM()		EPwm2Regs.AQCSFRC.bit.CSFA = 0;\
										EPwm2Regs.AQCSFRC.bit.CSFB = 0;

#define 		mEnForceNUHigh()		EPwm1Regs.AQCSFRC.bit.CSFA = 1;\
										EPwm1Regs.AQCSFRC.bit.CSFB = 2;
#define 		mEnForceNULow()			EPwm1Regs.AQCSFRC.bit.CSFA = 2;\
...
INV_CONTROL INT16S	swGetInvPWM(void);
INV_CONTROL INT16S	swGetg_wLoopOutput(void);
INV_CONTROL INT16S	swGetg_dwInvVoltCtrlVo(void);
...
INV_CONTROL void	sSetRSinPointer(INT16S wValue);
INV_CONTROL void	sSetInvVoltCtrlParaKv(INT16S wValue);
INV_CONTROL void	sSetInvVoltCtrlParaKi(INT16S wValue);
INV_CONTROL void	sSetInvVoltCtrlParaCurrLimit(INT16S wValue);
