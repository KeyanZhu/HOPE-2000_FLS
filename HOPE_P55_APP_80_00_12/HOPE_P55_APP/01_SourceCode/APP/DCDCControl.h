...
#define cDCDCConvertPeriod				872		// 88K	852	// 88K = 150MHz/2/(852)
#define cDCDCConvertPeriodDef			872		// 88K	852	// 88K = 150MHz/2/(852)
#define cDCDCConvertPeriodMax			872		// 88K	852	// 88K = 150MHz/2/(852)
#define cDCDCConvertPeriodMax47Pct		410		// 88K	313	// 88K = 150MHz/2/(852)*47%
...
LLC_CONTROL INT16U	suwGetHighSoftFinish(void);					
...
LLC_CONTROL void	sSetHighSoftFinish(INT16U uwTemp);	
