...
//	EPWM_enableDigitalCompareTripCombinationInput(EPWM1_BASE,EPWM_DC_COMBINATIONAL_TRIPIN7,EPWM_DC_TYPE_DCAH);//
	...
	// Clear trip flags
	// 清除标志
	EPWM_clearTripZoneFlag(EPWM1_BASE, EPWM_TZ_INTERRUPT | EPWM_TZ_FLAG_OST | EPWM_TZ_FLAG_DCAEVT2 | EPWM_TZ_FLAG_CBC);
...
//	EPWM_enableDigitalCompareTripCombinationInput(EPWM2_BASE,EPWM_DC_COMBINATIONAL_TRIPIN7,EPWM_DC_TYPE_DCAH);//
	...
	EPWM_enableTripZoneSignals(EPWM2_BASE, EPWM_TZ_SIGNAL_DCBEVT2);
	...
	// Clear trip flags
	// 清除标志
	EPWM_clearTripZoneFlag(EPWM2_BASE, EPWM_TZ_INTERRUPT | EPWM_TZ_FLAG_OST | EPWM_TZ_FLAG_DCAEVT2 | EPWM_TZ_FLAG_CBC);    
}
