...
INT16U g_uwBatSoftOCurrCnt = 0;			// 电池软件过压故障
INT16U g_uwBatSoftOCurrRstCnt = 0;
...
void sFaultRstCntProc(INT16U uwFilter)
{
	...
	if(g_uwBatSoftOCurrCnt > 0 && g_uwBatSoftOCurrCnt < 3)
	{
		if(g_uwBatSoftOCurrRstCnt > 3600)		//60*60 = 1H
		{
			g_uwBatSoftOCurrRstCnt = 0;
			g_uwBatSoftOCurrCnt = 0;
		}
	}
	else
	{
