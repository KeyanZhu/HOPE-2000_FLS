...
const struct EepromStruct2 strEepromDefaultTable2 = 	
{
	...
	//AC
	1,//0,			//	uwEEGridInputRange;			//	240	电网输入范围
	...
	650,		//	uwEEGridCurrLimit;			//	267	市电电流限制
	...
	1500,		//	uwEEGridPeakShavingPower;	//	276 电网削峰功率
...
//	if(suwGetEEBatVoltage() != (cBatVoltReal12V*uwBatSerialPcs))
	...
	if((suwGetEEBatLowShutDownVolt() > cBatVoltReal3V25 * uwBatSerialPcs) \
		|| (suwGetEEBatLowShutDownVolt() < cBatVoltReal2V08 * uwBatSerialPcs))
	{
