...
enum EEPROM_WRITE_DATA_ID	// IVDM
{
	...
	EE_uwEERsvd97, 					//	192 预留
	EE_uwEERsvd98, 					//	193 预留
	EE_uwEERsvd99, 					//	194 预留
	EE_uwEERsvd100, 				//	195 预留
	EE_uwEERsvd101, 				//	196 预留
	EE_uwEERsvd102, 				//	197 预留
	EE_uwEERsvd103, 				//	198 预留
...
//		    else
		...
		case EE_uwEEBatVoltage:
			if((WrData == cBatVoltReal12V))//||(WrData == cBatVoltReal24V))
			{
...
extern INT16S 	wLLCHTempFanPer;		// LLC高压侧温度折算风扇百分比
extern INT16S 	wTraTempFanPer;			// LLC变压器温度折算风扇百分比
extern INT16S 	wPVTempFanPer;			// PV温度折算风扇百分比
...
extern INT16S g_wPvLoadCurrFeedWard3;
extern INT16U uwPvChgCurrTemp;
extern INT16U uwPvChgBatCurrRef;

extern INT16S	g_wPvErrorCurrFeedWard4;
extern INT16S	wBatChgCurrErrFeedWard4;
extern INT16S	wBatChgCurrErrTemp;
extern INT16U	uwCurrDelay;
INT16U	swTestCmdRead(INT16U RdAddr)
{
	INT16U wTemp;
	...
	switch(RdAddr)
	{
		...
		break;
		case DBG_XXXXXXX04:			// 智能负载继电器使能
			wTemp = 04;//suwGetSmoatLoadOutEn();
		break;
		case DBG_XXXXXXX05:
			wTemp = 5;
		break;
		...
		case DBG_XXXXXXX14:			// DCDC频率
			wTemp = (cCPU_FREQ/2/suwGetDCDCConvPWMPeriod());
		break;
		...
		break;
		case DBG_XXXXXXX32:			// PV控制_母线电压参考(0.01V)
			wTemp = 32;//suwGetPvChgBusVoltRef();
		break;
		...
		break;
		case DBG_XXXXXXX34:			// PV控制器充电电流参考(0.01A)
			wTemp = suwGetPvBatChgLimit();
		break;
		case DBG_XXXXXXX35:			// PV防反MOS管
			wTemp = 35;//hoPVRLY;
		break;
		case DBG_XXXXXXX36:			// PV当前电流
			wTemp = (INT16S)((INT32S)swGetBatCurrNew() * swGetBatVoltNew() / swGetPv1VoltNew() / 10);
		break;
		...
		break;
		case DBG_XXXXXXX40:
			wTemp = g_wPvLoadCurrFeedWard3;
		break;
		case DBG_XXXXXXX41:
			wTemp = uwPvChgCurrTemp;
		break;
		case DBG_XXXXXXX42:
			wTemp = uwPvChgBatCurrRef;
		break;
		...
		break;
		case DBG_XXXXXXX76:
			wTemp = suwGetSysDeratingStatus();
		break;
		case DBG_XXXXXXX77:					// LLC高压侧过温降功率
			wTemp = 77;//swGetLLCHTempDeratPowerLimit();
		break;
		case DBG_XXXXXXX78:					// LLC变压器温度降额功率
		...
		break;
		case DBG_XXXXXXX83:
			wTemp = 83;//mLLCIOVERReset;
		break;
		case DBG_XXXXXXX84:		// 市电N线继电器
			wTemp =84;// hoGRIDNRLY;
		break;
		case DBG_XXXXXXX85:		// 逆变继电器
			wTemp = 85;//hoRINVRLY;
		break;
		...
		break;
		case DBG_XXXXXXX88:		// PV降额输出电流
			wTemp = swGetTempDeratPvBatCurrFilter();
		break;
		case DBG_XXXXXXX89:		// LLC高压侧温度降额电压
			wTemp = 89;//swGetLLCHTempDeratVoltLimit();
		break;
		case DBG_XXXXXXX90:		// LLC变压器温度降额电压
		...
		break;
		case DBG_XXXXXXX93:
			wTemp = 93;//sGetInvVoltCtrlParaKv();
		break;
		case DBG_XXXXXXX94:
			wTemp = 94;//sGetInvVoltCtrlParaKi();
		break;
		case DBG_XXXXXXX95:
			wTemp = 95;
		break;
...
INT8U	swTestCmdWrite(INT16U WrAddr, INT16U WrData)
{
	...
	switch(WrAddr)
	{
		...
		case DBG_XXXXXXX31:				// PV控制_MPPT电压参考(0.01V)
			;
		break;
		case DBG_XXXXXXX32:				// PV控制_母线电压参考(0.1V)
			if(WrData <= 9900)			// 990V
			{
//				sSetPvChgBusVoltRef(WrData);
			}
		break;
		case DBG_XXXXXXX33:				// 调试寄存器写入的PV充电目标电流(1A)
			if(WrData <= 200)			// 200A
		...
		case DBG_XXXXXXX83:
			;
		break;
		case DBG_XXXXXXX84:					// 市电N线接入继电器(1吸合 0断开)
		{
//			if(WrData == true)				// GRIDN.RLY
//			{
//				sSetGridNRelayOn(true);
//			}
//			else
//			{
...
//			}
		...
		break;
		case DBG_XXXXXXX85:					// 逆变继电器(1吸合 0断开)
		{
//			if(WrData == true)				// INV.RLY
//			{
//				sSetInvRelayOn(true);
//			}
//			else
...
//			}
		...
		break;
		case DBG_XXXXXXX93:
			sSetInvVoltCtrlParaKv(WrData);
		break;
		case DBG_XXXXXXX94:
			sSetInvVoltCtrlParaKi(WrData);
		break;
		case DBG_XXXXXXX95:
			;
		break;
