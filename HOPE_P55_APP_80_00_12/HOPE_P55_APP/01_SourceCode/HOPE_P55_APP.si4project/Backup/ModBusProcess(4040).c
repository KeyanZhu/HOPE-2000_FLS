...
//			wTemp = (cCPU_FREQ/2/cDCDCPeriod);
		...
		break;
		case DBG_XXXXXXX19:
			wTemp = suwGetGridChgBatLowCutFlag();
		break;
		case DBG_XXXXXXX20:
			wTemp = suwGetPv1PWMupLimit2();
		break;
		case DBG_XXXXXXX21:
			wTemp = suwGetPv1PWMB();
		break;
		case DBG_XXXXXXX22:
			wTemp = swGetWattDeratROpVolt();
		break;
		...
		break;
		case DBG_XXXXXXX75:	
			wTemp = mPV_FANEN;//swGetCtrlVoltFlag();
		break;
		...
		break;
		case DBG_XXXXXXX93:
			wTemp = suwGetLLCMinDutyTime();
		break;
		case DBG_XXXXXXX94:
			wTemp = suwGetLLCSoftDutyRate();
		break;
		case DBG_XXXXXXX95:
			wTemp = hoLCDCLK;
		break;
...
INT8U	swTestCmdWrite(INT16U WrAddr, INT16U WrData)
{
	...
	switch(WrAddr)
	{
		...
		break;
		case DBG_XXXXXXX19:		
			sSetGridChgBatLowCutFlag(WrData);
		break;
		case DBG_XXXXXXX20:		
			sSetPv1PWMupLimit2(WrData);
		break;
		case DBG_XXXXXXX21:		
			;
		break;
		...
		break;
		case DBG_XXXXXXX93:
			sSetLLCMinDutyTime(WrData);
		break;
		case DBG_XXXXXXX94:
			sSetLLCSoftDutyRate(WrData);
		break;
		case DBG_XXXXXXX95:
			;
		break;
