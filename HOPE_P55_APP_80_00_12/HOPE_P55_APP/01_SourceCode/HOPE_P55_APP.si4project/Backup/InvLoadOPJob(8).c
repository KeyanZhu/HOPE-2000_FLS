...
//		g_uwTurboMode = true;
	...
	if((wWattTemp > 200) && (swGetWorkMode() == cBatteryMode)&&(g_uwTurboMode == true))
	{
		uwWattDeratePerTemp = (wWattTemp - 200) / 5;
...
INT16S sOPOverLoadLowvolt(INT16S wOpVoltTemp)
{
	...
	if(wOPLOadTemp > 1050)
	{
		...
		|| ((wOPLOadTemp <  600) &&(wOPLOadTemp >= 400) && (g_uwOPLoadLevelCnt > cT3sec))\
		|| ((wOPLOadTemp <  400) &&(wOPLOadTemp >= 200) && (g_uwOPLoadLevelCnt > cT10sec)))
		{
			g_uwTurboMode = true;
...
//			}
			...
			|| ((wOPLOadTemp <  600) &&(wOPLOadTemp >= 400) && (g_uwOPLoadLevelCnt > cT10sec))\
			|| ((wOPLOadTemp <  400) &&(wOPLOadTemp >= 200) && (g_uwOPLoadLevelCnt > cT15sec)))
		{
			g_uwTurboMode = false;
