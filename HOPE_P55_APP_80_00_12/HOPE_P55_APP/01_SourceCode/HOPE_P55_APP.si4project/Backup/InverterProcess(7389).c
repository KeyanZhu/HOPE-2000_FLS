...
//	}
	...
	strInverterRealtimeData.Field.wBatLTemp = 0;//swGetHsBatLTempFilter();
	strInverterRealtimeData.Field.wLLCHTemp = 0;//swGetHsLLCHTempFilter();
	strInverterRealtimeData.Field.wLLCTraTemp = 0;//swGetHsTraTempFilter();
