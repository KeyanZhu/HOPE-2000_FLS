...
/***************************设备信息********************************/
// 逆变器机型
#define cCtrlHOPE1000					0			// HOPE1000
...
// DSP软件子版本
#define cCtrlV00					0	// 工程建立，基本配置，功能模块等
#define cCtrlV01					1	// 逻辑层的初步完善
#define cCtrlV02					2	// 屏蔽了很多功能代码，调整了些采样系数
#define cCtrlV03					3	// 20251215
#define cCtrlV04					4	// 20251215
#define cCtrlV05					5	// 增加LLC谐振腔电流、逆变电流的TZ保护
#define cCtrlV06					6	// 打开自动逻辑，调整DCDC软起完成标识，优化PV闭环发波模式逻辑
#define cCtrlV07					7	// 调整并网PR控制器参数
#define cCtrlV08					8
#define cCtrlV09					9
#define cCtrlV10					10
#define cCtrlV11					11
...
#define cDspTempVersion				cCtrlV07	// 当前编译版本
...
// 设备类型
#define MACHINE_TYPE_HOPE             0x0060		// 设备大类 HOPE			// 0x0058 = 88
...
#define cMaxInvFeedCntlCurr1        20//226    		// 22.6A(3200W*1.414/200V=15A*1.414=22.6A)		// 0.1A

#define cMaxACInputCurr             500    		// RLY=
#define cMaxACInputPower            500    	// 7000W	// 市电最大功率 230V*30A=6900W
#define cMaxPVBatChgCurr            10000		// 15000    // PV充电电流，150A,量产是100A
#define cDCDCCntlCurrntLimit        3200		// 1600    // 15*100 15A
#define cBatDischgCurrMax           15000    	// 150A
#define cLiBatActChgCurr            50      	// 5A
#define cInvWattMax                 500			// 500W
#define cInvVAMax					500			// 500W
...
#define cMpptPVCurr10A				1000
#define cMpptPVCurr35A				3500
#define cMpptPVCurrMax				cMpptPVCurr10A
