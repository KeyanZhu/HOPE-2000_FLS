...
//		wAdcRealSumCntTemp[emuADC_RLINE_VOLT] = 0;
	...
	wAdcResult1[cADC_CH_LV12V]				= ADCARESULT8;				// LV_12V.V
	wAdcResult1[cADC_CH_OP_VOLT]			= ADCARESULT9 - 2048;		// OP.V
	wAdcResult1[cADC_CH_LLC_OCP]			= ADCARESULT10 - 2048;		// LLC.OCP
...
void	sAdcDCDCIsr(void)
{
	...
	wAdcResult2[cADC_CH_LV12V]				= ADCARESULT8;				// LV_12V.V
	wAdcResult2[cADC_CH_OP_VOLT]			= ADCARESULT9 - 2048;		// OP.V
	wAdcResult2[cADC_CH_LLC_OCP]			= ADCARESULT10 - 2048;		// LLC.OCP
