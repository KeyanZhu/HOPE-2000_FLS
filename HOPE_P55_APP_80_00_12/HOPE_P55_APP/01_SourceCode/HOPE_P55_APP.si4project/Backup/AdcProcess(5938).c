...
#define	cBatCurrRatio			7920		// ±198.00AMax	0.01A	K=100*3.3/(50.0*0.085714)	1.65Vbias
...
//		wAdcRealSumCntTemp[emuADC_RLINE_VOLT] = 0;
	...
	wAdcResult1[cADC_CH_OP_CURR]			= ADCARESULT2 - 2048;		// OP.I
...
void	sAdcDCDCIsr(void)
{
	...
	wAdcResult2[cADC_CH_OP_CURR]			= ADCARESULT2 - 2048;		// OP.I
