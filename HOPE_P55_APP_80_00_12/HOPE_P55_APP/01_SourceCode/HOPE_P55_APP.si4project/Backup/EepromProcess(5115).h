...
typedef struct
{
	...
	INT16U	uwEEBatSeriesNum;			//	129	电池节数
	INT16U	uwEEBatActivate;			//	130	电池激活
	INT16U	uwEEBatCapacity; 			//	131	电池容量
	...
	INT16U	uwEERsvd97; 				//	192 预留
	INT16U	uwEERsvd98; 				//	193 预留
	INT16U	uwEERsvd99; 				//	194 预留
	INT16U	uwEERsvd100; 				//	195 预留
	INT16U	uwEERsvd101; 				//	196 预留
	INT16U	uwEERsvd102; 				//	197 预留
	INT16U	uwEERsvd103; 				//	198 预留
...
EEPROM	INT16U	suwGetEERsvd102(void);
EEPROM	INT16U	suwGetEERsvd103(void);
...
EEPROM	void	sSetEERsvd102(INT16U uwtemp);
EEPROM	void	sSetEERsvd103(INT16U uwtemp);
