/*
   Define the memory block start/length for the F28P55x  
   PAGE 0 will be used to organize program sections
   PAGE 1 will be used to organize data sections

   Notes: 
         Memory blocks on F28P55x are uniform (ie same
...
PAGE 0:    /* Program Memory */
   ...
   OSStackRAM		: origin = 0x008000, length = 0x001000		// = RAMLS0 | RAMLS1
   //RAMLS0           : origin = 0x008000, length = 0x000800
   //RAMLS1           : origin = 0x008800, length = 0x000800

   // RAMLS = RAMLS2 | RAMLS3 | RAMLS4 | RAMLS5 | RAMLS6 | RAMLS7 | RAMGS
   RAMLS			: origin = 0x009000, length = 0x003000		// 0x007000
   ...
   //RAMGS			: origin = 0x00C000, length = 0x004000		// RAMGS = RAMGS0 | RAMGS1
   //RAMGS0           : origin = 0x00C000, length = 0x002000
   //RAMGS1           : origin = 0x00E000, length = 0x002000
   //RAMGS2           : origin = 0x010000, length = 0x002000	// 550SG9没有这个区块
   //RAMGS3           : origin = 0x012000, length = 0x002000	// 550SG9没有这个区块

   /* Flash Banks (128 sectors each) */
   FLASH_FINV       : origin = 0x080002, length = 0x1FFFE		// FLASH_BANK0
   //FLASH_BANK2      : origin = 0x0C0000, length = 0x20000		// FLASH_BANK2
   //FLASH_BANK4      : origin = 0x100000, length = 0x08000		// FLASH_BANK4
   
   //FLASH_FINV       : origin = 0x080002, length = 0x1FFFE		// FLASH_BANK0
   //FLASH_BANK1      : origin = 0x0A0000, length = 0x20000		// FLASH_BANK1	// 550SG9没有这个区块
   //FLASH_BANK2      : origin = 0x0C0000, length = 0x20000		// FLASH_BANK2
   //FLASH_BANK3      : origin = 0x0E0000, length = 0x20000		// FLASH_BANK3	// 550SG9没有这个区块
   //FLASH_BANK4      : origin = 0x100000, length = 0x20000		// FLASH_BANK4
...
UNION run = PIEVECTTABLE
{
   ...
   .text            : >> FLASH_FINV, ALIGN(8)

   .cinit           : > FLASH_FINV, ALIGN(8)
   .switch          : > FLASH_FINV, ALIGN(8)
   ...
   .bss             : > RAMLS
   .bss:output      : > RAMLS
   .init_array      : >> FLASH_FINV, ALIGN(8)
   .const           : >> FLASH_FINV, ALIGN(8)
   .data            : > RAMLS
   .sysmem          : > RAMLS
  .bss:cio          : > RAMLS
#else
   .pinit           : >> FLASH_FINV, ALIGN(8)
   .ebss            : > RAMLS
   .econst          : >> FLASH_FINV, ALIGN(8)
   .esysmem         : > RAMLS
   .cio             : > RAMLS
#endif
...
//    }				
   ...
   OSStack          : > OSStackRAM, ALIGN(8)
   DataBuff         : > OSStackRAM, ALIGN(8)

   
   /*  Allocate IQ math areas: */
   //IQmath           : > FLASH_FINV, ALIGN(8)
  // IQmathTables     : > FLASH_FINV, ALIGN(8)
