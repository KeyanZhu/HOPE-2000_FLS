...
// PV_FAN.EN	 PV防反信号
#define PV_FANEN     		GpioDataRegs.GPBDAT.bit.GPIO42
#define mPV_FANENOn 		GpioDataRegs.GPBCLEAR.bit.GPIO42 = 1    
#define mPV_FANENOff 		GpioDataRegs.GPBSET.bit.GPIO42 = 1
