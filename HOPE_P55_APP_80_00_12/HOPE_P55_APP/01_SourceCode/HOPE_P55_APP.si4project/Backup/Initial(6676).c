...
//	AdcbRegs.ADCSOC0CTL.bit.CHSEL= 27;		// SOC0 will convert ADCINA27
...
//	AnalogSubsysRegs.AGPIOCTRLG.bit.GPIO232 = 1;	// ADC 
	GpioCtrlRegs.GPHAMSEL.bit.GPIO232 = 1;			// 开启模拟功能
	...
	// LCD.EN
	GpioCtrlRegs.GPAPUD.bit.GPIO25 = 0; 	// Enable pullup on GPIO17		// 使能上拉
