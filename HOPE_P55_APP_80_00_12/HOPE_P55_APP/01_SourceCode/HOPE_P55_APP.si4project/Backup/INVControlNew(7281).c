...
void	sFBBUSController2(void)// 并网BUS电压外环
{
	...
	if(++g_wLoopCnt >= 8)
	{
		...
		else if(g_wBusVoltErr < -cBusVoltReal20V)
		{
			g_wBusVoltErr = -cBusVoltReal20V;
		}
		...
		////////////////////////////////////////////////////////////电池电压外环  母线电压限幅
		g_wPBusVoltErr2 = 4700 - g_wPBusVoltAvg;			//控制母线最大电压470V                          暂定
		g_wBusVoltErr2 = g_wPBusVoltErr2;
		if(g_wBusVoltErr2 > cBusVoltReal20V)			// 20V
		{
			g_wBusVoltErr2 = cBusVoltReal20V;
		}
		else if(g_wBusVoltErr2 < -cBusVoltReal20V)
		{
			g_wBusVoltErr2 = -cBusVoltReal20V;
		}
