...
void	sOPCurrOverChk(INT16U uwOPOverCurrLevel, INT16U uwFilter)
{
	...
	{
		if((sb16UOverLevelChk(wROpCurrNew, g_uwOPCurrOverLevel1, cT20sec, &s_uwOPOverLoadChkCnt))\
		|| (sb16UOverLevelChk(wROpCurrNew, g_uwOPCurrOverLevel2, cT1sec, &s_uwOPOverLoadChkCnt))\
		|| (sb16UOverLevelChk(wROpCurrNew, g_uwOPCurrOverLevel3, cT30ms, &s_uwOPOverLoadChkCnt)))
		{
			s_uwOPOverLoadChkCnt = 0;
