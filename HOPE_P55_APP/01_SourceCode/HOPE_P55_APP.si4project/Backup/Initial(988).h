...
//#################################################################################################//
#define ADCRESULT0			AdcaResultRegs.ADCRESULT0	// INV.V	A0
#define ADCRESULT1			AdcaResultRegs.ADCRESULT1	// INV.I	A2
#define ADCRESULT2			AdcaResultRegs.ADCRESULT2	// OP.I		A3
#define ADCRESULT3			AdcaResultRegs.ADCRESULT3	// VBAT.V	A4
#define ADCRESULT4			AdcaResultRegs.ADCRESULT4	// BUS.V	A5
#define ADCRESULT5			AdcaResultRegs.ADCRESULT5	// GRID.V	A6
#define ADCRESULT6			AdcaResultRegs.ADCRESULT6	// BAT.V	A9
#define ADCRESULT7			AdcaResultRegs.ADCRESULT7	// AC_12V.V	A11
#define ADCRESULT8			AdcaResultRegs.ADCRESULT8	// LV_12V.V	A12
#define ADCRESULT9			AdcaResultRegs.ADCRESULT9	// OP.V		A14
#define ADCRESULT10			AdcaResultRegs.ADCRESULT10	// LLC.OCP	A15
#define ADCRESULT11			AdcaResultRegs.ADCRESULT11	// VAR		A16
#define ADCRESULT12			AdcaResultRegs.ADCRESULT12	// BAT.I	A18
#define ADCRESULT13			AdcaResultRegs.ADCRESULT13	// B1.V		A28
#define ADCRESULT14			AdcaResultRegs.ADCRESULT14	// INV.T	A26
#define ADCRESULT15			AdcaResultRegs.ADCRESULT15

#define ADCBRESULT0			AdcbResultRegs.ADCBRESULT0	// PV.I				B7
#define ADCBRESULT1			AdcbResultRegs.ADCBRESULT1	// PV.INCURR.TZ		B30
#define ADCBRESULT2			AdcbResultRegs.ADCBRESULT2	// PV.INCURR		B0
#define ADCBRESULT3			AdcbResultRegs.ADCBRESULT3	// PV.V				B1
#define ADCBRESULT4			AdcbResultRegs.ADCBRESULT4	// B2.V				B4
#define ADCBRESULT5			AdcbResultRegs.ADCBRESULT5	// PV.T				B27
#define ADCBRESULT6			AdcbResultRegs.ADCBRESULT6	// BAT1.T			B5
#define ADCBRESULT7			AdcbResultRegs.ADCBRESULT7	// BAT2.T			B11
#define ADCBRESULT8			AdcbResultRegs.ADCBRESULT8	// LLC.T			B26
#define ADCBRESULT9			AdcbResultRegs.ADCBRESULT9
#define ADCBRESULT10		AdcbResultRegs.ADCBRESULT10
#define ADCBRESULT11		AdcbResultRegs.ADCBRESULT11
#define ADCBRESULT12		AdcbResultRegs.ADCBRESULT12
#define ADCBRESULT13		AdcbResultRegs.ADCBRESULT13
#define ADCBRESULT14		AdcbResultRegs.ADCBRESULT14
#define ADCBRESULT15		AdcbResultRegs.ADCBRESULT15

#define ADCCRESULT0			AdccResultRegs.ADCCRESULT0	// B.V		// C27
#define ADCCRESULT1			AdccResultRegs.ADCCRESULT1
#define ADCCRESULT2			AdccResultRegs.ADCCRESULT2
#define ADCCRESULT3			AdccResultRegs.ADCCRESULT3				
#define ADCCRESULT4			AdccResultRegs.ADCCRESULT4
#define ADCCRESULT5			AdccResultRegs.ADCCRESULT5
#define ADCCRESULT6			AdccResultRegs.ADCCRESULT6
#define ADCCRESULT7			AdccResultRegs.ADCCRESULT7
#define ADCCRESULT8			AdccResultRegs.ADCCRESULT8
#define ADCCRESULT9			AdccResultRegs.ADCCRESULT9
#define ADCCRESULT10		AdccResultRegs.ADCCRESULT10
#define ADCCRESULT11		AdccResultRegs.ADCCRESULT11
#define ADCCRESULT12		AdccResultRegs.ADCCRESULT12
#define ADCCRESULT13		AdccResultRegs.ADCCRESULT13
#define ADCCRESULT14		AdccResultRegs.ADCCRESULT14
#define ADCCRESULT15		AdccResultRegs.ADCCRESULT15
...
#define mKEYSPSOn 			GpioDataRegs.GPBSET.bit.GPIO56 = 1
#define mKEYSPSOff 			GpioDataRegs.GPBCLEAR.bit.GPIO56 = 1
...
#define hoLCDEn     		GpioDataRegs.GPADAT.bit.GPIO25
