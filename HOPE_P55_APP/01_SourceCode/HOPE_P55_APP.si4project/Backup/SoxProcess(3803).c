...
{
	wEnergyPct80Volt = 350;//swGetEepromCellVoltPct80();
	wEnergyPct20Volt = 250;//swGetEepromCellVoltPct20();
	wEnergyPct20TwoVolt = 230;//swGetEepromCellVoltPct20Two();
	wEnergyPct05Volt = wEnergyPct20Volt - 100;
	wEnergyCompCoeff = 0;//swGetEepromCellTempCoef();
